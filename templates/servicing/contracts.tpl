...
<div class="container">
  ...
  <form class="form-horizontal" role="form">
    <fieldset>
      ...
      <div class="col-md-1">
       <button class="btn btn-primary btn-block" name="add" type="submit" disabled>Edit</button>
      </div>
    </div>
    </fieldset>
  </form>
  ...
  <form class="form-horizontal" role="form">
    <fieldset>
      ...
      <div class="col-md-1">
       <button class="btn btn-danger btn-block" name="add" type="submit" disabled>Add</button>
      </div>
    </div>
    </fieldset>
  </form>
